	...
	// if (isset($_POST['submit'])) {
		if ($_SERVER['REQUEST_METHOD'] == 'POST' ) :
			...
			// =====================================================//
				...
				if (isset($err)) {
					foreach ($err as $val) :
						echo '<div class="alert-prev alert alert-warning text-center"><span class="glyphicon glyphicon-warning-sign" style="color:#cd5c5c;"></span> '.$val.'<br/></div>';
					endforeach;
				}
